...
function Card({ producto }) {
	...
	return (
		<article
			className="w-full max-w-xl pb-4 bg-[#e0e0e0] rounded-lg"
		...
		>
			...
			<div className="px-5 pb-5 flex flex-col items-center gap-4">
				<div>
					<h5 className="text-3xl font-semibold text-gray-900 pt-4">
						Pizza {name}
					</h5>
				</div>
				<div className="flex flex-col items-center justify-center gap-2">
					...
					<span className="text-2xl text-center h-14">
						🍕 {ingredients.join(", ")}
					</span>
				</div>
				...
				<div className="flex items-center justify-between gap-24 pt-6">
					<button
						type="button"
						className="text-gray-900 text-center bg-[#e0e0e0bc] border-2 border-black/25 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-2xl px-5 py-2.5 me-2 mb-2"
					>
						Ver Más 👀
					</button>
					<button
